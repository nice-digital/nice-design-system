...
There are four variations of the alert component, all of which can be set to 'nonIntrusive' if required:
...
```
```html HTML
<div class="alert alert--info" data-component="alert--info" aria-live="polite">
	<h3>Info alert</h3>
	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
</div>
```
