...
```
```html HTML
<div class="alert alert--info" data-component="alert--info">
	<h3>Info alert</h3>
	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
</div>
```
...
```
```html HTML
<div class="alert alert--success" data-component="alert--success">
	<h3>Success alert</h3>
	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
</div>
```
...
```
```html HTML
<div class="alert alert--error" data-component="alert--error">
	<h3>Error alert</h3>
	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
</div>
```
...
```
```html HTML
<div class="alert alert--caution" data-component="alert--caution">
	<h3>Caution alert</h3>
	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
</div>
```
