...
You can add a headingLevel to form groups to define the heading level of the legend. The value can be set from 1 to 6, corresponding to heading levels h1 through h6.

If no heading level is provided, the component falls back to the default behavior.
