...
<Example>
	...
	<CH.Code>
		```js React
		<Card headingText="Card title 1" headingLevel="6" summary="Card text 1" />
	```

	```html HTML
	<article class="card" data-component="card"><header class="card__header"><h6 class="card__heading"><a href="https://www.example.com">Card with heading level 6</a></h6></header><p class="card__summary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce sed nisi enim. In nec lorem ac est cursus sollicitudin molestie vel nunc.</p></article>
	```
	</CH.Code>
</Example>
