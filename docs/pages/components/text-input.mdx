...
import { DefaultInput, ErrorInput, HintInput, GroupedInputs, GroupedInputHints } from "components/examples/Input";
...
<FormGroup legend="What is your address">
	...
	<Input label="Address line 1" name="addressLine2" />
...
<fieldset class="form-group" data-component="form-group">
	...
	<div class="input" data-component="input">
		...
		<input class="input__input" type="text" value="">
	</div>
	<div class="input" data-component="input">
		<label class="input__label">Address line 1</label>
		<input class="input__input" type="text" value="">
	...
	<div class="input" data-component="input">
		<label class="input__label">Town or city</label>
		<input class="input__input" type="text" value="">
	</div>
	<div class="input" data-component="input">
		<label class="input__label">County</label>
		<input class="input__input" type="text" value="">
	</div>
	<div class="input" data-component="input">
...
<Example>
<h2>Example: Grouped inputs with a hint</h2>
<GroupedInputHints />
