...
import { DefaultCheckbox, DefaultExampleCheckbox, InlineCheckbox, HintCheckbox, ErrorCheckbox } from "components/examples/Checkbox";
...
[Add option for "none" checkbox example]
...
[Form group with a hint Live demo]
...
{/* - A user has selected two contradictory options. For example if they selected 'none' and 'Spain' in 'Have you travelled to any of these countries recently?'  */}
...
The error message text appears in red after the question text and any hint text.
