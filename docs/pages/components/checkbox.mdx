...
<Example>
	...
	<CH.Code>
		...
		<fieldset class="form-group" data-component="form-group">
			...
			<div class="checkbox" data-component="checkbox">
				<div>
					<input type="checkbox" class="checkbox__input" id="contact-none-example_email" name="contact-none-example" value="email">
					<label class="checkbox__label" for="contact-none-example_email">Email</label>
				</div>
			</div>
			<div class="checkbox" data-component="checkbox">
				<div>
					<input type="checkbox" class="checkbox__input" id="contact-none-example_telephone" name="contact-none-example" value="telephone">
					<label class="checkbox__label" for="contact-none-example_telephone">Telephone</label>
				</div>
			</div>
			<div class="checkbox" data-component="checkbox">
				<div>
					<input type="checkbox" class="checkbox__input" id="contact-none-example_sms" name="contact-none-example" value="sms">
					<label class="checkbox__label" for="contact-none-example_sms">Text message</label>
				</div>
			</div>
			<div class="checkbox" data-component="checkbox">
				<div>
					<input type="checkbox" class="checkbox__input" id="contact-none-example_none" name="contact-none-example" value="none">
					<label class="checkbox__label" for="contact-none-example_none">I do not wish to be contacted</label>
				</div>
			</div>
		</fieldset>
		```
	...
	<CH.Code>
		...
		<fieldset class="form-group" data-component="form-group--inline">
			...
			<div class="checkbox checkbox--inline" data-component="checkbox">
				<div>
					<input type="checkbox" class="checkbox__input" id="contact-inline_email" name="contact-inline" value="email">
					<label class="checkbox__label" for="contact-inline_email">Email</label>
				</div>
			</div>
			<div class="checkbox checkbox--inline" data-component="checkbox">
				<div>
					<input type="checkbox" class="checkbox__input" id="contact-inline_telephone" name="contact-inline" value="telephone">
					<label class="checkbox__label" for="contact-inline_telephone">Telephone</label>
				</div>
			</div>
			<div class="checkbox checkbox--inline" data-component="checkbox">
				<div>
					<input type="checkbox" class="checkbox__input" id="contact-inline_sms" name="contact-inline" value="sms">
					<label class="checkbox__label" for="contact-inline_sms">Text message</label>
				</div>
			</div>
		</fieldset>
		```
