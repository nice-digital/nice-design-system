...
<fieldset class="form-group" data-component="form-group">
  ...
  <div class="radio" data-component="radio">
    <input
      ...
      name="contact-preference-default"
      type="radio"
      id="contact-preference-default_yes"
      value="yes"
    />
    <label class="radio__label" for="contact-preference-default_yes">
      Yes
    </label>
  </div>
  ...
  <div class="radio" data-component="radio">
    <input
      ...
      name="contact-preference-default"
      type="radio"
      id="contact-preference-default_no"
      value="no"
    />
    <label class="radio__label" for="contact-preference-default_no">
      No
    </label>
  </div>
</fieldset>
...
<fieldset class="form-group" data-component="form-group">
  ...
  <div class="radio" data-component="radio">
    <input
      ...
      name="contact-preference-hint-group"
      type="radio"
      id="contact-preference-hint-group_yes"
      value="yes"
    />
    <label class="radio__label" for="contact-preference-hint-group_yes">
      Yes
    </label>
  </div>
  ...
  <div class="radio" data-component="radio">
    <input
      ...
      name="contact-preference-hint-group"
      type="radio"
      id="contact-preference-hint-group_no"
      value="no"
    />
    <label class="radio__label" for="contact-preference-hint-group_no">
      No
    </label>
  </div>
</fieldset>
...
<fieldset class="form-group" data-component="form-group">
  ...
  <p class="radio__error-message" id="contact-preference-error">
    Error message
  </p>
  ...
  <div class="radio radio--error" data-component="radio">
    <input
      ...
      name="contact-preference-error-hint"
      type="radio"
      id="contact-preference-error-hint_yes"
      value="yes"
      aria-describedby="contact-preference-error"
    />
    <label class="radio__label" for="contact-preference-error-hint_yes">Yes</label>
  </div>
  ...
  <div class="radio" data-component="radio">
    <input
      ...
      name="contact-preference-error-hint"
      type="radio"
      id="contact-preference-error-hint_no"
      value="no"
      aria-describedby="contact-preference-error"
    />
    <label class="radio__label" for="contact-preference-error-hint_no">No</label>
  </div>
</fieldset>
```
</CH.Code>
