...
<fieldset class="form-group" data-component="form-group">
  ...
  <div class="radio" data-component="radio">
    <input
      ...
      name="grouphintradio"
      type="radio"
      id="grouphintradio_yes"
      value="yes"
    />
    <label class="radio__label" for="grouphintradio_yes">Yes</label>
  </div>
  ...
  <div class="radio" data-component="radio">
    <input
      ...
      name="grouphintradio"
      type="radio"
      id="grouphintradio_no"
      value="no"
    />
    <label class="radio__label" for="grouphintradio_no">No</label>
  </div>
</fieldset>
...
<fieldset class="form-group" data-component="form-group">
  ...
  <p class="radio__error-message" id="errorhintradio-error">
    Error message
  </p>
  ...
  <div class="radio radio--error" data-component="radio">
    <input
      ...
      value="yes"
      aria-describedby="errorhintradio-error"
    />
