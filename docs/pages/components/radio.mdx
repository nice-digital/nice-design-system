...
import { DefaultRadio, DefaultRadioExample, InlineRadio, HintRadio,GroupHintRadio, ErrorRadio, ErrorHintRadio} from "components/examples/Radio";
...
<fieldset class="form-group" data-component="form-group">
  ...
  <div class="radio" data-component="radio">
    <input
      ...
      name="contact-preference"
      type="radio"
      id="contact-preferencee_yes"
      value="yes"
    />
    <label class="radio__label" for="contact-preference_yes">
      Yes
    </label>
  </div>
  ...
  <div class="radio" data-component="radio">
    <input
      ...
      value="no"
    />
    <label class="radio__label" for="contact-preference_no">
      No
    </label>
  </div>
</fieldset>
...
<fieldset class="form-group" data-component="form-group">
  ...
  <p class="radio__error-message"></p>
