...
The primary goal of the test was to increase clicks of buttons, counted using ‘many per session’ logic. 
We estimated a 3 week test duration, at a 3% baseline conversion rate and an expected 450,000 total sessions across the three variants. 
