...
| ----------------------------------------------------------- | ------ | -------- | ----- | ------------- |
| <span class="spacing-block spacing-block--xx-small"></span> | 2px    | 0.125rem | a     | `$xx-small`   |
| <span class="spacing-block spacing-block--x-small"></span>  | 4px    | 0.25rem  | b     | `$x-small`    |
| <span class="spacing-block spacing-block--small"></span>    | 8px    | 0.5rem   | c     | `$small`      |
| <span class="spacing-block spacing-block--medium"></span>   | 16px   | 1rem     | d     | `$medium`     |
| <span class="spacing-block spacing-block--large"></span>    | 32px   | 2rem     | e     | `$large`      |
| <span class="spacing-block spacing-block--x-large"></span>  | 48px   | 3rem     | f     | `$x-large`    |
| <span class="spacing-block spacing-block--xx-large"></span> | 64px   | 4rem     | g     | `$xx-large`   |
...
```
.component {
    border-top: core.em(core.$xx-small) solid core.$colour-border;
    margin: core.rem(core.$medium 0 core.$large);
    padding: core.rem(core.$medium);

    @include core.mq($from: md) {
        margin: core.rem(core.$large 0);
    }
}
```
