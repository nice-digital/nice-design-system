...
description: A way for users to navigate to previous or next pages in a sequence of content.
inpagenav: true
template: detail
storybook: components-previous-next
github: components/nds-prev-next
npm: nds-prev-next
---

import { PrevNext } from "@nice-digital/nds-prev-next";

<div className="panel panel--default pb--0">
	<PrevNext
		nextPageLink={{
			text: "Page Header",
			destination: "#"
