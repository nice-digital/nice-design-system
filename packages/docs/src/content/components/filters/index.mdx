...
heading: "Filter by updated date"
};
...
For the filter by input, you can use any standard input, but it defaults to a text input. You can use any of the [variants on our input component](http://localhost:6006/?path=/story/foundations-input--try-it-out) such as an error message or hint text.
