...
<div className="grid">
	...
	<div data-g="12 xs:6 sm:4 md:3">
		...
		<ul>
			<li>
				<s>Colour documentation</s>
			</li>
			<li>
				<s>Grid examples</s>
			</li>
			<li>
				<s>SASS coding standards</s>
			</li>
	...
	<div data-g="12 xs:6 sm:4 md:3">
		...
		<ul>
			<li>
				<s>SASS Doc generation</s>
			</li>
			<li>
				<s>SASS and JS linting</s>
			</li>
	...
	<div data-g="12 xs:6 sm:4 md:3">
		...
		<ul>
			<li>
				<s>Grunt build process</s>
			</li>
			<li>
				<s>Live reload</s>
			</li>
			<li>
				<s>Webfont (from SVGs)</s>
			</li>
...
<div className="grid">
	...
	<div data-g="12 xs:6 sm:4 md:3">
		...
		<ul>
			...
			<li>
				<a
					href="http://documentation.js.org/"
					target="_blank"
	...
	<div data-g="12 xs:6 sm:4 md:3">
		...
		<ul>
			...
			<li>
				JS{" "}
				<a href="https://flowtype.org/" target="_blank" rel="noopener external">
	...
	<div data-g="12 xs:6 sm:4 md:3">
		...
		<ul>
			<li>
				NPM Scripts (option to use{" "}
				<a
					href="https://www.keithcirkel.co.uk/how-to-use-npm-as-a-build-tool/"
					target="_blank"
					rel="noopener external"
				>
					NPM as build tool
...
<div className="grid">
	...
	<div data-g="12 xs:6 sm:4 md:3">
		...
		<ul>
			...
			<li>
				Wider content style guide e.g. tone of voice,{" "}
				<a
					href="http://styleguide.mailchimp.com/grammar-and-mechanics/"
					target="_blank"
					rel="noopener external"
				>
					grammar &amp; mechanics
	...
	<div data-g="12 xs:6 sm:4 md:3">
		...
		<ul>
			<li>
				<a
					href="https://github.com/mattonfoot/NICE.TopHat"
					target="_blank"
					rel="noopener external"
				>
					TopHat
