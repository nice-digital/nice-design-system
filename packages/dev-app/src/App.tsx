		...
		return (
			<Router history={browserHistory}>
				<Container>
					<Grid>
						<GridItem md={2}>
							<ul className="hide-print list list--unstyled">
								<li>
						...
						<GridItem md={10}>
							...
							<Route
								...
								component={SimplePaginationView}
							/>
							...
							<p>
								...
								consectetur adipisicing elit. Consequatur minima molestiae nisi
								qui, reprehenderit tempora! Amet consequuntur ducimus illum
								incidunt maxime molestiae possimus quae quasi quisquam ratione
								reprehenderit, soluta, ullam unde voluptate voluptatibus.
								Aliquam atque blanditiis dolorem eius eos esse facere facilis
								fugit illo labore laboriosam laborum maiores necessitatibus
